...
namespace ProductsStore.WebAPI.Models
{
    /// <summary>
    /// Stores the data in json file so that no database is required for this
    /// sample application
    /// </summary>
    public class ProductRepository
    {
        ...
        internal void Delete(int id)
        {
            ...
            if (itemIndex > 0)
            {
                Product prod = products.FirstOrDefault(p => p.ProductId == id);
